...
void resample2(struct particle[], uint8_t, uint16_t[], uint8_t);
...
int main() {
    ...
    while(1) {
        ...
        */
        ...
        /* resample particles */
        resample2(particle_array, num_towers, tower_loc, sensor_val);
...
*/
void resample2(struct particle particle_array[], uint8_t num_towers, uint16_t tower_loc[], uint8_t sensor_val) {
