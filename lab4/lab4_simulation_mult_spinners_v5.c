...
void resample_particles(struct particle[], uint8_t, uint16_t[], uint8_t);
...
int main() {
    ...
    while(1) {
        ...
        */
        ...
        resample_particles(particle_array, num_towers, tower_loc, sensor_val);
...
void resample_particles(struct particle particle_array[], uint8_t num_towers, uint16_t tower_loc[], uint8_t sensor_val) {
...
//            .weight = random_weight // unimportant, will get updated in the next iteration of algorithm
        ...
        // printf("%d", sensor_val);
        // printf("\n");
        // printf("Random Angle OG:");
        // printf("%.6f", random_angle);
        resampled_particle_array[i] = p;
        struct particle* current_particle_ptr = &(resampled_particle_array[i]);
        // printf("Press ENTER key to print noise before proper values. ");
        // getchar();
        // printf("Random Angle: ");
        // printf("%.6f", current_particle_ptr->angle);
        // printf(", ");
        // printf("Random Weight (should be 0): ");
        // printf("%.6f", p.weight);
        // printf(", ");
        // printf("Random Class (should be 0): ");
        // printf("%d", p.classification);
        // printf("\n");
        // getchar();

        // printf("Press ENTER key to print resampled_array before updated values.");
        // getchar();
        // print_particle_array_everything(resampled_particle_array);
        classify_particle(num_towers, tower_loc, current_particle_ptr);
        update_particle_weight(current_particle_ptr, sensor_val);
        // printf("Press ENTER key to print noise AFTER proper values. ");
        // getchar();
        // printf("Random Angle:  p.angle: ");
        // printf("%.6f", p.angle);
        // printf(", cur_part_ptr: ");
        // printf("%.6f", current_particle_ptr->angle);
        // printf(", ");
        // printf("Corresponding Random Weight: p.weight: ");
        // printf("%.6f", p.weight);
        // printf(", cur_part_ptr: ");
        // printf("%.6f", current_particle_ptr->weight);
        // printf(", ");
        // printf("Corresponding Class: p.class: ");
        // printf("%d", p.classification);
        // printf(", cur_part_ptr: ");
        // printf("%d", current_particle_ptr->classification);
        // printf("\n");
        // printf("Press ENTER key to print resampled_array after updated values.");
        // getchar();
        // print_particle_array_everything(resampled_particle_array);
        // printf("Added to resampled_array. Press ENTER key to continue.");
        // getchar();
    }
