...
lab: ./final_project/final_project_v3.c $(wildcard $(BOARD_LIB)/*.c)
	avr-gcc -I$(BOARD_LIB) -DF_CPU=$(CLOCK_RATE) -Wall -mmcu=atmega645a -O2 -o main.elf ./final_project/final_project_v3.c $(wildcard $(BOARD_LIB)/*.c)
