 ...
 * Description: This program gradually spins the motors forward to full speed, stops, then gradually slows down
 * until it stops and repeats in reverse direction.
*/
#include "globals.h"
